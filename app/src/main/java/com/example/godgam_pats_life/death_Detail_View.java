...
public class death_Detail_View extends AppCompatActivity {
    float x;
    float y;
    String number;
    String name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_death__detail__view);
        loadDB();
    }
    ...
    public void onClickButton(View v){
        ...
        switch (id){
            case R.id.button4:
                intent = new Intent(death_Detail_View.this,MapsActivity.class);
                name = i.getExtras().getString("b");
