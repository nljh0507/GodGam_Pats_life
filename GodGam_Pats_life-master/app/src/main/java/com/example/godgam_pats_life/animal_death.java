...
public class animal_death extends ListActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_animal_death);
        loadDB();
    }
    ...
    public void onClickButton(View v){
        ...
        Cursor c = db.rawQuery("SELECT * FROM petdeath Where new_address LIKE '"+a+"%';", null);
    ...
    public void loadDB(){
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS petdeath "
                + "(_id INTEGER PRIMARY KEY AUTOINCREMENT,cname INTEGER not null unique, name TEXT, age INTEGER);");

        final Cursor c = db.rawQuery("SELECT * FROM petdeath;", null);
        ...
        Iv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                Intent intent = new Intent(animal_death.this, sales_Detail_View.class);
